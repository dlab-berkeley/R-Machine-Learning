...
**Solution 4**: Each is a potential combination of hyperparamters, or
...
hyperparamters. We can see that the first combination yields an accuracy
of about 81.11%. What does this tell us about how much regularization we
should use?

Instead of picking the combination of hyperparamters that yields the
best accuracy, we can automate this procedure. The `select_best`
...
Notice our final accuracy on the test is about 80.85%, whereas our accuracy on the training set was higher at 81.11%. Why is our test accuracy lower? 

**Solution 5**: We selected our hyperparameters (i.e., the penalty function) to yield the highest output specifically on our training set. 
