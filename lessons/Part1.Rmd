...
```{r}
set.seed(100) # ensure we all see the same sample 
...
Determine the extent to which missing values are a problem in this data set. *Hint*: try using the `colSums()` function. 
